...
const double distance_threshold = 0.25;                             // maximale Abweichung zur Ebene um als Inlier zu gelten in [ m ]    
const double prob = 0.99;                                           // probability of choosing at least one sample free from outliers 0.99 = 99%

// Parameter RANSAC front
const double max_angle_front = perc2rad(5);                         // maximale Winkelabweichung zur Axe in [ Crad ]
...
const double max_angle_mid = perc2rad(3);                           // maximale Winkelabweichung zur Axe in [ Crad ]
...
const double max_angle_rear = perc2rad(5);                          // maximale Winkelabweichung zur Axe in [ Crad ]
